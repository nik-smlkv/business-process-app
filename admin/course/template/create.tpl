			...
			<div class="main__body">
				<div class="admin__block">
					<ul class="admin__list">
						<li class="admin__item"><a href="../admin.php">Курсы<span></a></li>
				...
				<div class="admin__post">
					<div class="admin__title"><h2>Добавление курсов</h2></div>
					<div class="course__form">
						<form action="" method="post">
							<div class="form__item">
								<p>Название</p>
								<input class="form__input" type="text" name="name" placeholder="Введите название">
							</div>
							<div class="form__item">
								<p>Подзаголовок</p>
								<input class="form__input" type="text" name="text" placeholder="Введите подзаголовок">
							</div>
							<div class="form__item">
								<p>Ссылка</p>
								<input class="form__input" type="text" name="link" placeholder="Введите путь страницы">
							</div>
							...
							<div class="admin__buttons">
								<button class="course__add" type="submit" name="course-create" value="Добавить">Добавить</button>
							</div>
						</form>
					</div>
				</div>
