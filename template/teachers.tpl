               ...
               <div class="course_page">
                  <h2 class="title_course_page">
                     Преподаватели
						...
						<div class="teachers__page">                  
							<p>
								Наш золотой фонд проекта. Студенты получают знания от практикующих специалистов с опытом работы не менее трех лет и сами проходят обучения по сегодняшний день
							</p>
						</div>
               </div>
