            ...
            <div class="_container">
               <div class="course_page">
                  <h2 class="title_course_page">
                     О проекте BusinessMind
                  </h2>
						<div class="business__page">                  
							<p>
								Имеет статус частного учреждения дополнительного образования 
								(лицензия на осуществление образовательной деятельности № 02100/483 от 12.05.2014) и функционирует с 2015 года.
							</p>
						</div>
               </div>
				</div>
						...
						<div class="_container">
							<div class="project__body">
								<div class="project__block">
									<div class="project__title"><h2>Международный проект профессий</h2></div>
									<div class="project__subtitle"><p>С 2019 года в нашем учебном центре обучилось более 10 000 учеников. Вы можете
										пройти обучение по 54 специальностям в области маркетинга, бизнеса, дизайна, медиа, программирования. Каждый
										курс — это выжимка прикладных знаний от более чем 600 экспертов-практиков, трудившихся над созданием наших
										программ. Обучение проходит в двух форматах: онлайн, в виде живых трансляций с обратной связью и домашними
										заданиями, и традиционном — непосредственно в вашем городе.</p></div>
									<div class="project__button">
										<div class="container-login100-form-btn">
											<div class="wrap-login100-form-btn">
												<div class="login100-form-bgbtn"></div>
												<button class="btn-free-consult login100-form-btn button__business" type="submit" data-fancybox="" data-src="#modal-free-consult">Наши преподаватели</button>
											</div>
										</div>
									</div>
								</div>
								<div class="project__img"><img src="img/belarus-map.png" alt=""></div>
							</div>
						</div>
					</div>
					<div class="_container">
						<div class="history">
							...
							<div class="history__body">
								<div class="history__img"><img src="img/history.png" alt=""></div>
								<ul class="history__list">
									<li class="history__item"><span>2018</span> — открытие проекта в Минске</li>
									<li class="history__item"><span>2019</span> — выпуск более 200 учеников, запуск 5 новых программ</li>
									<li class="history__item"><span>2020</span> — выпуск более 400 учеников, запуск 10 новых программ, выход на онлайн площадку</li>
									<li class="history__item"><span>2021</span> — выпуск более 800 учеников, запуск 12 новых программ, обеспечение трудоустройства для выпускников</li>
									<li class="history__item"><span>2022</span> — выпуск более 1000 учеников, запуск 10 новых программ, запуск стажировок</li>
								</ul>
							</div>
						</div>
					</div>
